...
const SamsaraIntegration = () => {
  ...
  const fetchVehicleStats = async (vehicle) => {
    ...
    try {
      // Request comprehensive telematics data
      const types = "gps,engineStates,obdOdometerMeters,fuelPercents,faultCodes,engineRpm,engineLoadPercent,engineCoolantTemperatureMilliC";
            ...
            <div className="p-6">
              ...
              {loadingStats ? (
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">
                            {vehicleStats.gps.speed ? `${Math.round(vehicleStats.gps.speed * 2.237).toLocaleString()} mph` : '0 mph'}
                          </p>
                        </div>
                        <div>
                          <span className="text-sm text-gray-500">Heading</span>
                          <p className="font-medium">
                            {vehicleStats.gps.heading ? `${vehicleStats.gps.heading}°` : 'N/A'}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Fuel Level */}
                  {vehicleStats.fuelPercents !== undefined && (
                          ...
                          <div className="mt-1">
                            <div className="w-full bg-gray-200 rounded-full h-2.5">
                              <div 
                                ...
                                style={{ width: `${vehicleStats.fuelPercents}%` }}
                              ></div>
                            </div>
                            <p className="mt-1 font-medium">{vehicleStats.fuelPercents}%</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Engine Data */}
                  {(vehicleStats.engineRpm !== undefined || 
                    vehicleStats.engineLoadPercent !== undefined || 
                    vehicleStats.engineCoolantTemperatureMilliC !== undefined) && (
